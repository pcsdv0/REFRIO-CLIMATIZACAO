...
function openDetail(e) {
  ...
  a.innerHTML = "";
  detailBox.querySelector("#detail-desc").textContent = t.desc;
  t.images.forEach(e => {
...
window.addEventListener("click", e => {
  if (e.target === detailBox) detailBox.classList.add("hidden");
});
...
toast.id = "call-toast";
toast.textContent = "Número copiado! Ligue do seu telefone.";
...
(function() {
  ...
  a.addEventListener("click", () => {
    e.scrollBy({ left: i, behavior: "smooth" });
  });
